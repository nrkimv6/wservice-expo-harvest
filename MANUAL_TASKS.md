...
- [ ] `2F`에서 새 계단을 포함한 우측 4블록 lane이 한 column으로 정렬되어 보이는지 확인 — from: 2026-04-17_refine-coupang-map-booth-packing-and-copy-cleanup.md#16 (2026-04-17)
...
- [ ] `1F 전시관`에서 상·하단 계단 2개와 파란 `decorRect`가 함께 다시 보이는지 확인 — from: 2026-04-17_fix-coupang-map-layout-regressions-after-section-split.md#11 (2026-04-17)
